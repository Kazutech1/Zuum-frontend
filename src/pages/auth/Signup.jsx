    ...
    >
      ...
      >
        ...
        <div className="relative h-65 overflow-hidden">
          <div
            className={`w-full h-full bg-cover bg-center bg-no-repeat transition-all duration-700 ease-out ${isVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-105'
              }`}
            style={{
        ...
        <div className="flex-1 px-6 py-6 flex flex-col" style={{ backgroundColor: 'var(--color-bg-primary)' }}>
          <div className="flex-grow">
            ...
            {/* Welcome Text */}
            <div className={`text-center mb-6 transition-all duration-600 ease-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
              }`}>
              <h2
            ...
            {/* Form Content */}
            <div className={`space-y-4 transition-all duration-700 ease-out delay-200 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
              }`}>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center mt-4">
                      ...
                      <label htmlFor="terms" className="ml-2 text-sm" style={{ color: 'var(--color-text-secondary)' }}>
                        I agree to the <Link to="/terms-and-conditions" target="_blank" rel="noopener noreferrer" style={{ color: '#2D8C72', textDecoration: 'underline' }}>terms and conditions</Link>
                      </label>
                    </div>
                  </div>
                )}
