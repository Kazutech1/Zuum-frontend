...
const PromotionPlatforms = () => {
  ...
  return (
    ...
    >
      ...
      {/* Hero Section */}
      <div
        className={`py-12 px-4 text-white ${activeTab === 'youtube' ? 'bg-gradient-to-r from-red-900 to-red-700' :
      ...
      >
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <div className={`h-16 w-16 rounded-full flex items-center justify-center mx-auto ${activeTab === 'youtube' ? 'bg-red-700' :
          ...
          <div className="flex overflow-x-auto scrollbar-hide">
            {tabs.map((tab) => (
              <button
                ...
                className={`flex items-center px-4 py-2.5 rounded-lg whitespace-nowrap transition-all text-sm font-medium ${activeTab === tab.id
                    ? tab.id === 'tiktok'
                      ? 'bg-black text-white'
                      : tab.id === 'youtube'
          ...
          <div className="space-y-6">
            {getPackagesByCategory(activeTab).map((pkg) => (
              <motion.div
                ...
                className={`rounded-xl shadow-lg overflow-hidden border ${activeTab === 'youtube'
              ...
              >
                <div className={`p-6 backdrop-blur-sm ${activeTab === 'youtube' ? 'bg-red-900/30' : 'bg-black/30'
                  }`}>
                  <div className="flex justify-between items-start mb-4">
                    ...
                    <div className={`text-xl font-bold px-4 py-2 rounded-full ${activeTab === 'youtube' ? 'bg-white text-red-600' : 'bg-white text-black'
                      }`}>
                        ...
                        {pkg.features.map((feature, i) => (
                          <li key={i} className="flex items-start">
                            <div className="flex-shrink-0 mt-1">
                              <div className={`h-5 w-5 rounded-full flex items-center justify-center ${activeTab === 'youtube' ? 'bg-white text-red-600' : 'bg-white text-black'
                                }`}>
                  ...
                  <button
                    ...
                    className={`w-full py-3 px-4 rounded-lg font-bold text-lg transition-colors flex items-center justify-center ${activeTab === 'youtube'
